...
def print_five_million_watched_club():
    ...
    print_header(3)
    print_latest_additions(dates_added, titles, 1)
    print_next_to_join(len(titles))
    print("STATS:\n")
    print_first_film(five_million_watched_club, 1)
    print_fastest_film(five_million_watched_club, 1)
    ...
    print("Number Of Films Directed By Women: 3")
    print("Number Of Films Not In English: 2")
