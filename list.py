def print_list(lists, box_office_titles, box_office_years, option):
    if option == 1:
        lists_dict = {
            "one_million": {
            ...
            "500_most_watched": {
                "titles": list(lists["500 Most Watched Title"]),
                "years": list(lists["500 Most Watched Year"]),
                "count": 0,
            },
            "1000_most_watched": {
                "titles": list(lists["1000 Most Watched Title"]),
                "years": list(lists["1000 Most Watched Year"]),
                "count": 0
            }
        }
        ...
        print("Number of films in the Letterboxd 500 Most Watched Films List: " + str(lists_dict["500_most_watched"]["count"]))
        print("Number of films in the Letterboxd 1000 Most Watched Films List: " + str(lists_dict["1000_most_watched"]["count"]))
    ...
    if option == 2:
        ...
        print("\nNumber Of Films In The Letterboxd Top 250: " + str(lists_dict["letterboxd"]["count"]))
        print("Number Of Films In The IMDb Top 250: " + str(lists_dict["imdb"]["count"]))
